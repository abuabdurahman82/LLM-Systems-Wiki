...
| Cerebras WSE-2 | 5 nm [F: p12] | ~750 TFLOPS FP16/wafer [F: p12] | 40 GB on-wafer SRAM [F: p12] | none [F] | on-wafer (20 PB/s aggregate for WSE-2, not point-to-point [F: p12]) | Compiler-placed dataflow [F] | FP16/BF16 [F: p12] |
...
| AWS Trainium2 | (8 NeuronCore-v3) [F: p13] | ~1.3 PFLOPS FP8 dense/chip (= 8 × 158 core-level cFP8) [F: p13] | 224 MiB SBUF/core [F: p13] | 96 GiB HBM3e [F: p13] | 2.9 TB/s [F: p13] | Neuron compiler (offline) [F] | cFP8 (MX) [F: p13] |
...
| Groq GroqNode | 8 TSPs (C2C, 240 GB/s bisection [F: p14]) | Dragonfly (9 nodes/rack, 145 racks max [F: p14]) | 8×220 MiB = 1.72 GiB/node [E]; 10,440 TSPs ≈ 2.19 TiB [E] | Scheduled Dragonfly (not routed) [F: p14] | **< 3 µs worst-case E2E [F: ISCA 2022]** | Groq compiler (closed; no general-purpose path) [F] |
